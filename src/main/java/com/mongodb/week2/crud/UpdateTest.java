...
//                new UpdateOptions().upsert(true));    //if no exists, mongodb will create new document, if exists then - update


        collection.updateMany(gte("x", 5), inc("x", 1)); //if 'x' greater or equal 5 then increment 1
